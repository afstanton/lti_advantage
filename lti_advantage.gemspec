...
Gem::Specification.new do |spec|
  spec.name = "lti_advantage"
  spec.version = LtiAdvantage::VERSION
  spec.authors = ["Aaron F Stanton"]
  spec.email = ["afstanton@gmail.com"]

  spec.summary = "Implmentation of the LTI Advantage standard for Ruby."
  spec.homepage = "https://github.com/afstanton/lti_advantage"
  spec.license = "MIT"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] =  "https://github.com/afstanton/lti_advantage"
  else
